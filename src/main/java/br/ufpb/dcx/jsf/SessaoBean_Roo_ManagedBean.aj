...
import br.ufpb.dcx.jsf.SessaoBean;
...
privileged aspect SessaoBean_Roo_ManagedBean {
    
    declare @type: SessaoBean: @ManagedBean(name = "sessaoBean");
    
    declare @type: SessaoBean: @SessionScoped;
    
    @Autowired
    UsuarioService SessaoBean.usuarioService;
    
    private String SessaoBean.name = "Usuarios";
    
    private List<Usuario> SessaoBean.allUsuarios;
    
    private boolean SessaoBean.dataVisible = false;
    
    private List<String> SessaoBean.columns;
    
    private HtmlPanelGrid SessaoBean.createPanelGrid;
    
    private HtmlPanelGrid SessaoBean.editPanelGrid;
    
    private HtmlPanelGrid SessaoBean.viewPanelGrid;
    
    private boolean SessaoBean.createDialogVisible = false;
    
    @PostConstruct
    public void SessaoBean.init() {
    ...
    public String SessaoBean.getName() {
        return name;
    }
    
    public List<String> SessaoBean.getColumns() {
        return columns;
    }
    
    public List<Usuario> SessaoBean.getAllUsuarios() {
        return allUsuarios;
    }
    
    public void SessaoBean.setAllUsuarios(List<Usuario> allUsuarios) {
        this.allUsuarios = allUsuarios;
    }
    
    public String SessaoBean.findAllUsuarios() {
        allUsuarios = usuarioService.findAllUsuarios();
        dataVisible = !allUsuarios.isEmpty();
        return null;
    }
    
    public boolean SessaoBean.isDataVisible() {
        return dataVisible;
    }
    
    public void SessaoBean.setDataVisible(boolean dataVisible) {
        this.dataVisible = dataVisible;
    }
    
    public HtmlPanelGrid SessaoBean.getCreatePanelGrid() {
    ...
    public void SessaoBean.setCreatePanelGrid(HtmlPanelGrid createPanelGrid) {
        this.createPanelGrid = createPanelGrid;
    }
    
    public HtmlPanelGrid SessaoBean.getEditPanelGrid() {
    ...
    public void SessaoBean.setEditPanelGrid(HtmlPanelGrid editPanelGrid) {
        this.editPanelGrid = editPanelGrid;
    }
    
    public HtmlPanelGrid SessaoBean.getViewPanelGrid() {
        return populateViewPanel();
    }
    
    public void SessaoBean.setViewPanelGrid(HtmlPanelGrid viewPanelGrid) {
        this.viewPanelGrid = viewPanelGrid;
    }
    
    public HtmlPanelGrid SessaoBean.populateCreatePanel() {
        ...
        nomeCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.nome}", String.class));
        ...
        nickNameCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.nickName}", String.class));
        ...
        emailCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.email}", String.class));
        ...
        senhaCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.senha}", String.class));
        ...
        senhaDeRecuperacaoCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.senhaDeRecuperacao}", String.class));
        ...
        isAtivoCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.isAtivo}", Boolean.class));
        ...
        perfilCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.perfil}", PerfilEnum.class));
        perfilCreateInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{sessaoBean.completePerfil}", List.class, new Class[] { String.class }));
    ...
    public HtmlPanelGrid SessaoBean.populateEditPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        javax.faces.application.Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        nomeEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.nome}", String.class));
        ...
        nickNameEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.nickName}", String.class));
        ...
        emailEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.email}", String.class));
        ...
        senhaEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.senha}", String.class));
        ...
        senhaDeRecuperacaoEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.senhaDeRecuperacao}", String.class));
        ...
        isAtivoEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.isAtivo}", Boolean.class));
        ...
        perfilEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.perfil}", PerfilEnum.class));
        perfilEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{sessaoBean.completePerfil}", List.class, new Class[] { String.class }));
    ...
    public HtmlPanelGrid SessaoBean.populateViewPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        javax.faces.application.Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        nomeValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.nome}", String.class));
        ...
        nickNameValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.nickName}", String.class));
        ...
        emailValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.email}", String.class));
        ...
        senhaValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.senha}", String.class));
        ...
        senhaDeRecuperacaoValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.senhaDeRecuperacao}", String.class));
        ...
        isAtivoValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.isAtivo}", String.class));
        ...
        perfilValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{sessaoBean.usuario.perfil}", String.class));
        htmlPanelGrid.getChildren().add(perfilValue);
        
        return htmlPanelGrid;
    }
    
    public Usuario SessaoBean.getUsuario() {
        if (usuario == null) {
            usuario = new Usuario();
        }
        return usuario;
    ...
    public void SessaoBean.setUsuario(Usuario usuario) {
        this.usuario = usuario;
    }
    
    public List<PerfilEnum> SessaoBean.completePerfil(String query) {
    ...
    public String SessaoBean.onEdit() {
        return null;
    }
    
    public boolean SessaoBean.isCreateDialogVisible() {
        return createDialogVisible;
    }
    
    public void SessaoBean.setCreateDialogVisible(boolean createDialogVisible) {
        this.createDialogVisible = createDialogVisible;
    }
    
    public String SessaoBean.displayList() {
        createDialogVisible = false;
        findAllUsuarios();
        return "usuario";
    }
    
    public String SessaoBean.displayCreateDialog() {
        usuario = new Usuario();
        createDialogVisible = true;
        return "usuario";
    }
    
    public String SessaoBean.persist() {
        String message = "";
    ...
    public String SessaoBean.delete() {
    ...
    public void SessaoBean.reset() {
        usuario = null;
        createDialogVisible = false;
    }
    
    public void SessaoBean.handleDialogClose(CloseEvent event) {
        reset();
    }
